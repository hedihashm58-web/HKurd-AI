...
async def kurdish_flashcard_endpoint(request: FlashcardRequest, fastapi_req: Request):
    ...
    flashcard_prompt = (
        ...
        f"تکایە {cat_desc} هەڵبژێرە و تەواوی زانیاری و هاوتاکانی بە زاراوە جیاوازەکانی کوردی بە شێوازی JSONی ڕاستەوخۆ بنووسە:\n"
        "{\n"
        '  "word": "وشە سەرەکییەکە بە کوردی سۆرانی",\n'
        '  "meaning_kurdish": "مانا و ڕوونکردنەوەی ووردی وشەکە بە کوردی سۆرانی",\n'
        '  "kurmanji": "هاوتای تەواوی وشەکە بە کرمانجی سەروو / بادینی",\n'
        '  "hawrami": "هاوتای تەواوی وشەکە بە هەورامی",\n'
        '  "kelhuri": "هاوتای تەواوی وشەکە بە کەلهوڕی / فەیلی / لکی",\n'
        '  "zazaki": "هاوتای تەواوی وشەکە بە زازاکی / دملکی",\n'
        ...
        "}\n\n"
        "یاسای زۆر گرنگ بۆ زاراوەکان: بە هیچ شێوەیەک هیچ زاراوەیەک بە بەتاڵی جێمەهێڵە یان هێڵی '-' دامەنێ. تەنانەت ئەگەر لە کرمانجی، هەورامی یان کەلهوڕیدا هەمان وشە بەکارهاتبێت، ڕێک هەمان وشە یان شێوەی گۆکردنەکەی لەو زاراوەیەدا بنووسە.\n"
        "وەڵامەکەت تەنها JSON بێت بەبێ هیچ پێشەکییەک."
    )
