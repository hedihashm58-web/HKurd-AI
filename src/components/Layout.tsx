      ...
      <header className="glass-header sticky top-1 z-50 px-6 lg:px-12 py-6 flex justify-between items-center border-b border-white/[0.02] mx-2 lg:mx-6 mt-2 rounded-[2.5rem] shadow-2xl bg-slate-900/60 backdrop-blur-md">
        ...
        <div className="flex items-center">
          <button
            ...
            className="group flex items-center gap-4 lg:gap-8 px-6 lg:px-10 py-3 lg:py-4 bg-slate-800/50 border border-slate-700 rounded-2xl hover:bg-slate-700/60 active:bg-slate-700 transition-all shadow-xl active:scale-[0.98]"
          >
            <div className="hidden sm:flex flex-col items-end">
              <span className="text-xs font-black text-white tracking-widest">خزمەتگوزارییەکان</span>
